...
// write file json
writeJson('./i18n/rmhub/CtlFallNavigator.de.json', {'ctlFallNavigator': arrayToObject(ctlFallNavigatorDe)});
writeJson('./i18n/rmhub/CtlFallNavigator.fr.json', {'ctlFallNavigator': arrayToObject(ctlFallNavigatorFr)});
writeJson('./i18n/rmhub/CtlFallNavigator.it.json', {'ctlFallNavigator': arrayToObject(ctlFallNavigatorIt)});
...
var localizationSourceFilesFr = [
  "./i18n/rmhub/CtlFallNavigator.fr.json",
  "./i18n/rmhub/CtlPendenzenVerwaltung.fr.json"
];

var localizationSourceFilesIt = [
  "./i18n/rmhub/CtlFallNavigator.it.json"
];
